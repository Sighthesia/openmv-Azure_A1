...
#define OMV_CSI_D5_PIN (&omv_pin_E5_DCMI) // OV Y8
...
// #define OMV_QSPI_ENABLE (1)
// #define OMV_QSPI_CS_PIN (&omv_pin_B6_QSPI)   // CS#
// #define OMV_QSPI_CLK_PIN (&omv_pin_B2_QSPI)  // CLK
// #define OMV_QSPI_IO0_PIN (&omv_pin_C9_QSPI)  // DI (IO0)
// #define OMV_QSPI_IO1_PIN (&omv_pin_C10_QSPI) // DO (IO1)
// #define OMV_QSPI_IO2_PIN (&omv_pin_E2_QSPI)  // WP# (IO2)
// #define OMV_QSPI_IO3_PIN (&omv_pin_D13_QSPI) // HOLD# (IO3)
