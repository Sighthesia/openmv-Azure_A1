...
// Memory map.
#if defined(OMV_RUN_QSPI)
#define OMV_FLASH_ORIGIN 0x90000000
#define OMV_FLASH_LENGTH 8192K
#else
...
// Flash configuration.
#if defined(OMV_RUN_QSPI)
#define OMV_FLASH_TXT_ORIGIN 0x90000000
#define OMV_FLASH_TXT_LENGTH 8192K
#else
...
// #define DCMI_RESET_PIN
// #define DCMI_RESET_PORT

#define DCMI_PWDN_PIN (GPIO_PIN_7)
#define DCMI_PWDN_PORT (GPIOA)

// #define DCMI_FSYNC_PIN
// #define DCMI_FSYNC_PORT
...
*/
// 修改 SOFT_I2C 引脚以避免与 FIR_I2C 冲突，使用其他可用引脚
#define SOFT_I2C_SIOC_PIN GPIO_PIN_10 // 使用 PB10
#define SOFT_I2C_SIOD_PIN GPIO_PIN_11 // 使用 PB11
...
#define OMV_SPI_LCD_RST_PORT                //(GPIOE)
...
#define OMV_SPI_LCD_RS_PORT                 (GPIOE)
...
#define OMV_SPI_LCD_BL_PIN                  (GPIO_PIN_10)
...
*/
// 修改为新的 LCD 引脚配置 - 使用 SPI1 接口
#define OMV_SPI_LCD_CONTROLLER (&spi_obj[0])
#define OMV_SPI_LCD_CONTROLLER_INSTANCE (SPI1)

#define OMV_SPI_LCD_MOSI_PIN (GPIO_PIN_7) // PA7 - LCD SDA
#define OMV_SPI_LCD_MOSI_PORT (GPIOA)
#define OMV_SPI_LCD_MOSI_ALT (GPIO_AF5_SPI1)

#define OMV_SPI_LCD_MISO_PIN (GPIO_PIN_6) // PA6 - SPI1 MISO (可选)
#define OMV_SPI_LCD_MISO_PORT (GPIOA)
#define OMV_SPI_LCD_MISO_ALT (GPIO_AF5_SPI1)

#define OMV_SPI_LCD_SCLK_PIN (GPIO_PIN_5) // PA5 - LCD SCL
#define OMV_SPI_LCD_SCLK_PORT (GPIOA)
#define OMV_SPI_LCD_SCLK_ALT (GPIO_AF5_SPI1)

#define OMV_SPI_LCD_RST_PIN // NRST - 使用系统复位，不需要单独配置
#define OMV_SPI_LCD_RST_PORT
#define OMV_SPI_LCD_RST_OFF() // 使用系统复位
#define OMV_SPI_LCD_RST_ON()  // 使用系统复位

#define OMV_SPI_LCD_RS_PIN (GPIO_PIN_2) // PD2 - LCD DC (数据/命令选择)
#define OMV_SPI_LCD_RS_PORT (GPIOD)
#define OMV_SPI_LCD_RS_OFF() HAL_GPIO_WritePin(OMV_SPI_LCD_RS_PORT, OMV_SPI_LCD_RS_PIN, GPIO_PIN_SET)
#define OMV_SPI_LCD_RS_ON() HAL_GPIO_WritePin(OMV_SPI_LCD_RS_PORT, OMV_SPI_LCD_RS_PIN, GPIO_PIN_RESET)

#define OMV_SPI_LCD_CS_PIN (GPIO_PIN_15) // PA15 - LCD CS (片选)
#define OMV_SPI_LCD_CS_PORT (GPIOA)
#define OMV_SPI_LCD_CS_HIGH() HAL_GPIO_WritePin(OMV_SPI_LCD_CS_PORT, OMV_SPI_LCD_CS_PIN, GPIO_PIN_SET)
#define OMV_SPI_LCD_CS_LOW() HAL_GPIO_WritePin(OMV_SPI_LCD_CS_PORT, OMV_SPI_LCD_CS_PIN, GPIO_PIN_RESET)

#define OMV_SPI_LCD_BL_PIN (GPIO_PIN_10) // PD10 - LCD BL (背光)
#define OMV_SPI_LCD_BL_PORT (GPIOD)
